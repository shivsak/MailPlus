...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-MailAppTests/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'CIOAPIClient.framework'
  install_framework 'ContextMenu_iOS.framework'
  install_framework 'FontAwesome_iOS.framework'
  install_framework 'HexColors.framework'
  install_framework 'JFMinimalNotifications.framework'
  install_framework 'OMGHTTPURLRQ.framework'
  install_framework 'PPiAwesomeButton.framework'
  install_framework 'RZTransitions.framework'
  ...
  install_framework 'TDOAuth.framework'
  install_framework 'TSMessages.framework'
  install_framework 'UIFloatLabelTextField.framework'
fi
